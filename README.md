...
To walkthrough an example of using the reference implementation, see the [walkthrough](https://github.com/onc-healthit/inferno-program/wiki/Walkthrough) on the wiki.
