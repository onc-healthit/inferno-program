  ...
  module Sequence
    class USCore311PractitionerroleSequence < SequenceBase
      ...
      details %(
        ...
        Because PractitionerRole resources are not required by USCDI, no searches are performed on this test sequence. Instead, references to
      ...
      test :validate_resources do
        ...
        bindings = USCore311PractitionerroleSequenceDefinitions::BINDINGS
