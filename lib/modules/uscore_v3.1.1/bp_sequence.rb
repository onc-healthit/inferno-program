  ...
  module Sequence
    class USCore311BpSequence < SequenceBase
      ...
      test :search_by_patient_category_date do
        ...
        @observation_ary = {}
        @resources_found = false
<<<<<<< HEAD:lib/modules/uscore_v3.1.1/bp_sequence.rb

=======
        search_query_variants_tested_once = false
>>>>>>> cb5da4fa16dccf8aa3d592009dc7bcd7bdc164b0:lib/modules/uscore_v3.1.1/bp_sequence.rb
...
<<<<<<< HEAD:lib/modules/uscore_v3.1.1/bp_sequence.rb
        save_delayed_sequence_references(provenance_results, USCore311BpSequenceDefinitions::DELAYED_REFERENCES)
=======
