  ...
  module Sequence
    class USCore310BodyheightSequence < SequenceBase
      ...
      details %(
        ...
        ## Profile Validation
        Each resource returned from the first search is expected to conform to the (US Core profile)[http://hl7.org/fhir/StructureDefinition/bodyheight].
      ...
      test :validate_resources do
        metadata do
          ...
          description %(
            ...
            This test checks if the resources returned from the first search conform to the [US Core Profile](http://hl7.org/fhir/StructureDefinition/bodyheight).
