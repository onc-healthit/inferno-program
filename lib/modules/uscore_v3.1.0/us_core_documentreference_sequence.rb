  ...
  module Sequence
    class USCore310DocumentreferenceSequence < SequenceBase
      ...
      details %(
        ...
        ## Profile Validation
        Each resource returned from the first search is expected to conform to the (US Core profile)[http://hl7.org/fhir/us/core/StructureDefinition/us-core-documentreference].
      ...
      test :search_by_patient do
        metadata do
          id '01'
          name 'Server returns results from DocumentReference search by patient'
      ...
      test :search_by__id do
        metadata do
          id '02'
          name 'Server returns results from DocumentReference search by _id'
          link 'https://www.hl7.org/fhir/us/core/CapabilityStatement-us-core-server.html'
          description %(
      ...
      test :search_by_patient_type do
        metadata do
          id '03'
          name 'Server returns results from DocumentReference search by patient+type'
          link 'https://www.hl7.org/fhir/us/core/CapabilityStatement-us-core-server.html'
          description %(
      ...
      test :search_by_patient_category_date do
        metadata do
          id '04'
          name 'Server returns results from DocumentReference search by patient+category+date'
          link 'https://www.hl7.org/fhir/us/core/CapabilityStatement-us-core-server.html'
          description %(
      ...
      test :search_by_patient_category do
        metadata do
          id '05'
          name 'Server returns results from DocumentReference search by patient+category'
          link 'https://www.hl7.org/fhir/us/core/CapabilityStatement-us-core-server.html'
          description %(
      ...
      test :search_by_patient_type_period do
        metadata do
          id '06'
          name 'Server returns results from DocumentReference search by patient+type+period'
          link 'https://www.hl7.org/fhir/us/core/CapabilityStatement-us-core-server.html'
          optional
          description %(
      ...
      test :search_by_patient_status do
        metadata do
          id '07'
          name 'Server returns results from DocumentReference search by patient+status'
          link 'https://www.hl7.org/fhir/us/core/CapabilityStatement-us-core-server.html'
          optional
          description %(
      ...
      test :validate_resources do
        metadata do
          ...
          description %(
            ...
            This test checks if the resources returned from the first search conform to the [US Core Profile](http://hl7.org/fhir/us/core/StructureDefinition/us-core-documentreference).
