...
module Inferno
  module Sequence
    class USCore310HeadOccipitalFrontalCircumferencePercentileSequence < SequenceBase
      ...
      test 'All must support elements are provided in the Observation resources returned.' do
        ...
        skip_if_not_found(resource_type: 'Observation', delayed: false)
        must_supports = USCore310HeadOccipitalFrontalCircumferencePercentileSequenceDefinitions::MUST_SUPPORTS
