  ...
  module Sequence
    class USCore310ProvenanceSequence < SequenceBase
      ...
      details %(
        ...
        Because Provenance resources do not exist in USCDI, no searches are performed on this test sequence. Instead, references to
        ...
        ## Profile Validation
        Each resource returned from the first search is expected to conform to the (US Core profile)[http://hl7.org/fhir/us/core/StructureDefinition/us-core-provenance].
      ...
      test :validate_resources do
        metadata do
          ...
          description %(
            ...
            This test checks if the resources returned from the first search conform to the [US Core Profile](http://hl7.org/fhir/us/core/StructureDefinition/us-core-provenance).
