  ...
  module Sequence
    class USCore310AllergyintoleranceSequence < SequenceBase
      ...
      details %(
        ...
        ## Profile Validation
        Each resource returned from the first search is expected to conform to the (US Core profile)[http://hl7.org/fhir/us/core/StructureDefinition/us-core-allergyintolerance].
      ...
      test :search_by_patient do
        metadata do
          id '01'
          name 'Server returns results from AllergyIntolerance search by patient'
      ...
      test :search_by_patient_clinical_status do
        metadata do
          id '02'
          name 'Server returns results from AllergyIntolerance search by patient+clinical-status'
          link 'https://www.hl7.org/fhir/us/core/CapabilityStatement-us-core-server.html'
          optional
          description %(
      ...
      test :validate_resources do
        metadata do
          ...
          description %(
            ...
            This test checks if the resources returned from the first search conform to the [US Core Profile](http://hl7.org/fhir/us/core/StructureDefinition/us-core-allergyintolerance).
