  ...
  module Sequence
    class USCore310PediatricWeightForHeightSequence < SequenceBase
      ...
      details %(
        ...
        ## Profile Validation
        Each resource returned from the first search is expected to conform to the (US Core profile)[http://hl7.org/fhir/us/core/StructureDefinition/pediatric-weight-for-height].
      ...
      test :search_by_patient_code do
        metadata do
          id '01'
          name 'Server returns results from Observation search by patient+code'
      ...
      test :search_by_patient_category_date do
        metadata do
          id '02'
          name 'Server returns results from Observation search by patient+category+date'
          link 'https://www.hl7.org/fhir/us/core/CapabilityStatement-us-core-server.html'
          description %(
      ...
      test :search_by_patient_category do
        metadata do
          id '03'
          name 'Server returns results from Observation search by patient+category'
          link 'https://www.hl7.org/fhir/us/core/CapabilityStatement-us-core-server.html'
          description %(
      ...
      test :search_by_patient_code_date do
        metadata do
          id '04'
          name 'Server returns results from Observation search by patient+code+date'
          link 'https://www.hl7.org/fhir/us/core/CapabilityStatement-us-core-server.html'
          optional
          description %(
      ...
      test :search_by_patient_category_status do
        metadata do
          id '05'
          name 'Server returns results from Observation search by patient+category+status'
          link 'https://www.hl7.org/fhir/us/core/CapabilityStatement-us-core-server.html'
          optional
          description %(
      ...
      test :validate_resources do
        metadata do
          ...
          description %(
            ...
            This test checks if the resources returned from the first search conform to the [US Core Profile](http://hl7.org/fhir/us/core/StructureDefinition/pediatric-weight-for-height).
