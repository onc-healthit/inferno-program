  ...
  module Sequence
    class USCore310CareplanSequence < SequenceBase
      ...
      details %(
        ...
        ## Profile Validation
        Each resource returned from the first search is expected to conform to the (US Core profile)[http://hl7.org/fhir/us/core/StructureDefinition/us-core-careplan].
      ...
      test :search_by_patient_category do
        metadata do
          id '01'
          name 'Server returns results from CarePlan search by patient+category'
      ...
      test :search_by_patient_category_date do
        metadata do
          id '02'
          name 'Server returns results from CarePlan search by patient+category+date'
          link 'https://www.hl7.org/fhir/us/core/CapabilityStatement-us-core-server.html'
          optional
          description %(
      ...
      test :search_by_patient_category_status_date do
        metadata do
          id '03'
          name 'Server returns results from CarePlan search by patient+category+status+date'
          link 'https://www.hl7.org/fhir/us/core/CapabilityStatement-us-core-server.html'
          optional
          description %(
      ...
      test :search_by_patient_category_status do
        metadata do
          id '04'
          name 'Server returns results from CarePlan search by patient+category+status'
          link 'https://www.hl7.org/fhir/us/core/CapabilityStatement-us-core-server.html'
          optional
          description %(
      ...
      test :validate_resources do
        metadata do
          ...
          description %(
            ...
            This test checks if the resources returned from the first search conform to the [US Core Profile](http://hl7.org/fhir/us/core/StructureDefinition/us-core-careplan).
