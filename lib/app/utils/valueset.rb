  ...
  class Terminology
    class Valueset
      ...
      CODE_SYS = {
        ...
        'urn:oid:2.16.840.1.113883.6.238' => ->(filter = nil) { Inferno::Terminology::Codesystem.new(FHIR::Json.from_json(File.read(resources/us_core_r4/CodeSystem-cdcrec.json))).filter_codes(filter)}
      }.freeze
